...
namespace Trumgu_IntegratedManageSystem.Models.xfund
{
    ...
    public class xfund_t_pf_sys_userObj
    {
        ...
        /// 是否开通九禹系统
        /// </summary>
        public int? ispass { get { return _ispass; } set { _ispass = value; } }

        private int? _isagree = null;
        /// <summary>
        /// 是否同意协议
        /// </summary>
        public int? isagree { get { return _isagree; } set { _isagree = value; } }

        private string _special_id = null;
        /// <summary>
        /// 九禹系统身份标识
        /// </summary>
        public string special_id { get { return _special_id; } set { _special_id = value; } }
    }

    public class xfund_t_pf_sys_userExObj : xfund_t_pf_sys_userObj
    {
        public xfund_t_pf_sys_userExObj()
        { }
    ...
    public class xfund_t_pf_sys_userSelObj
    {
